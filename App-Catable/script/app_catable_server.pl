...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{APP_CATABLE_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{APP_CATABLE_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
app_catable_server.pl - Catalyst Testserver

=head1 SYNOPSIS

app_catable_server.pl [options]
