...

{
    ...
    # TEST
    $mech->html_lint_ok(
        "Checking HTML validity and proper escaping",
    );

    # TEST
    like(
        $mech->title(),
        qr{\Q</title>See the <Cats&Dogs> - All posts\E},
        "Make sure there are no XSS attacks in the title.",
    );
}
